...
public class WallpaperUtils {
    ...
    /**
     * Log tag ：WallpaperUtils
     */
    private static final String LOG_TAG = "WallpaperUtils";
    ...
    public static void setBackground(ViewGroup vg, Activity activity) {
        // 取得主题背景配置信息
        SharedPreferences share = activity.getSharedPreferences(Constants.EXTRA_WEAC_SHARE,
        ...
        if (value != null) {
            ...
            if (drawable1 != null) {
                ...
                saveWallpaper(activity, Constants.WALLPAPER_NAME, Constants.DEFAULT_WALLPAPER_NAME);
